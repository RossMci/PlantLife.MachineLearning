...
//      var  model = keras.models.load_model(model_filepath);
//
...
//       var sunflower_path = tensorflow.keras.utils.get_file("Red_rose", origin=sunflower_url);
//
//       var img = tensorflow.keras.utils.load_img(
//                sunflower_path, new Size(img_height, img_width)
//);
//        var img_array = tensorflow.keras.utils.img_to_array(img);
//         img_array = tensorflow.expand_dims(img_array, 0); // Create a batch
//
//                var predictions = model.predict(img_array);
//       var  score = tensorflow.nn.softmax(predictions.get(0));
//
//        System.out.println(
